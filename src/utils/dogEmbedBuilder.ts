...
export default function DogEmbedBuilder(dog: DogApi[]) {
  ...
  const newEmbed = new EmbedBuilder()
    ...
    .setAuthor({
      name: "The Dog Api",
      iconURL:
        "https://cdn.discordapp.com/attachments/1091205360183947354/1131332787367051324/154-1542297_transparent-background-dog-icon-hd-png-download-713523227.png",
    })
